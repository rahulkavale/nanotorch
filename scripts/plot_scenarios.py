...
# This script visualizes our integration scenarios without polluting tests.
# It uses the same registry as tests, so any change to a scenario is reflected
# both in correctness checks and in plots.
